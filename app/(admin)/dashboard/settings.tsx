...
export default function AdminSettingsScreen() {
  ...
  const handleAboutPress = () => {
    Alert.alert(
      "About Study Space Admin",
      "Version 1.0.0\n\nStudy Space Admin Dashboard is designed for campus administrators to monitor and manage study spaces. This app provides analytics, feedback management, and AI-driven insights to help optimize study environments.",
      [{ text: "OK" }]
    );
  };
          ...
          <View style={styles.modalContent}>
            ...
            <ScrollView style={styles.modalBody}>
              ...
              <Text style={styles.policyText}>
                ...
                or contact customer support. This may include your name, email, and ID.
              </Text>
        ...
        <Animated.View entering={FadeInDown.delay(100).duration(500)}>
          <View style={styles.logoContainer}>
            <Image 
              ...
              resizeMode="contain"
            />
            <Text style={styles.appName}>Study Space Admin</Text>
